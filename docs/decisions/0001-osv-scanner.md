...
The M2 advisory resolver implements that boundary: valid live OSV data retains `osv` provenance; fallback data is schema-validated and retains `cached-demo` provenance. Proof-of-concept sections are excluded from normalized model context.
