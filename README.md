...
Before submission, the only active work is changing the uploaded [unlisted demo video](https://youtu.be/qxRCA4PA4LA) to public when approved and completing the submission package. The timed script and three consecutive golden-path rehearsals are complete; no new product feature enters the freeze path.
